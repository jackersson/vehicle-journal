...
def main():
    ...
    page = st.sidebar.radio("Сторінка", Page.items())
    ...
    cnt_stats_header = st.sidebar.empty()
    cnt_stats = st.sidebar.empty()
